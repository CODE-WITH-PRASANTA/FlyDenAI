...
const Step4UploadDocs = ({ handleGlobalFile, handlePrev, handleSubmitApplication }) => {
  return (
      ...
      <div className="VisaApplicationForm__upload-grid">
        <div className="VisaApplicationForm__upload-card">
          ...
          <input
            ...
            type="file"
            accept="image/*,.pdf"
            onChange={(e) => handleGlobalFile("passportCopy", e.target.files?.[0])}
          />
        </div>
        ...
        <div className="VisaApplicationForm__upload-card">
          ...
          <input
            ...
            type="file"
            accept="image/*"
            onChange={(e) => handleGlobalFile("photo", e.target.files?.[0])}
          />
        </div>
