...
const stories = [
  ...
  },
  {
    ...
    locationTo: 'United States',
    testimonial:
      'I applied to 4 universities and I got offers from 2 universities. Leverage Edu helped me through entire process to pursue masters. They have separate teams to handle all this.',
    category: 'Data Science',
    img: sc4,
    uniLogo: uniLogo3,
  },
